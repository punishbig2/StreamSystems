  ...
  return (
    <form>
      <Grid alignItems={'stretch'} container>
        <Grid xs={9} alignItems={'stretch'} container item>
          <Grid xs={6} item>
            <fieldset className={'full-height'}>
              ...
              <FormField type={'text'} name={'dealId'} label={'Deal Id'} value={entry.dealId} color={'green'}
                         readOnly/>
              <FormField type={'text'} name={'status'} label={'Status'} value={entry.status} color={'green'}
                         readOnly/>
              <FormField type={'text'} name={'buyer'} label={'Buyer'} value={entry.buyer} color={'cream'} readOnly/>
              <FormField type={'text'} name={'seller'} label={'Seller'} value={entry.seller} color={'cream'}
                         readOnly/>
              <FormField type={'text'} name={'legAdj'} label={'Leg Adj'} value={entry.legAdj} color={'green'}
                         readOnly/>
              <FormField type={'number'} name={'spot'} label={'Spot'} value={entry.spot} precision={4}
                         color={'orange'}
                         readOnly/>
          ...
          <Grid xs={6} item>
            <fieldset className={'full-height'}>
              ...
              <FormField type={'text'} name={'strategy'} label={'Strategy'} value={entry.strategy} color={'orange'}
                         readOnly/>
              <FormField type={'currency'} name={'notional'} label={'Notional'} value={entry.notional}
                         color={'orange'}
                         readOnly/>
              <FormField type={'text'} name={'expiry'} label={'Expiry'} value={entry.expiry} color={'orange'}
                         readOnly/>
              <FormField type={'text'} name={'strike'} label={'Strike'} value={entry.strike} color={'orange'}
                         readOnly/>
        ...
        <Grid xs={3} direction={'column'} justify={'space-between'} alignItems={'stretch'} container item>
          <Grid item>
            <fieldset>

...
export const emptyEntry = (tenor: string, symbol: string, strategy: string, user: string, quantity: string | null, type: EntryTypes): TOBEntry => {
  return {type: type, tenor, symbol, strategy, user, price: null, quantity, arrowDirection: ArrowDirection.None};
};
export const emptyOffer = (tenor: string, symbol: string, strategy: string, user: string, quantity: string | null = null): TOBEntry => {
  return emptyEntry(tenor, symbol, strategy, user, quantity, EntryTypes.Offer);
};

export const emptyBid = (tenor: string, symbol: string, strategy: string, user: string, quantity: string | null = null): TOBEntry => {

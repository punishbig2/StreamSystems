...
export const createDealFromBackendMessage = async (
  ...
  const deal = {
    ...
    buyer_user_email: data.buyer_user_email,
    seller: coalesce(data.sellerentitycode, data.seller),
    seller_user_email: data.seller_user_email,
...
export const createDealEntry = (
  ...
  const entry: DealEntry = {
    ...
    buyer: deal.buyer,
    buyer_user_email: deal.buyer_user_email,
    seller: deal.seller,
    seller_user_email: deal.seller_user_email,
